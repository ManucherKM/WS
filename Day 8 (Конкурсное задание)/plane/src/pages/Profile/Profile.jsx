      ...
      <div className='container'>
        <div className='flex flex-col items-center'>
          ...
          <div className='w-2/4 mt-20 lg:w-3/4 md:w-4/5'>
            ...
            <p className='text-xl flex mt-4 md:text-lg'>Дата регистрации: <span className='font-semibold ml-auto'>{user.dateRegister}</span></p>
          </div>
          <h2 className='font-medium text-2xl mt-28'>Мои полеты</h2>
          <div className='mt-10 mb-20 flex flex-wrap gap-10 justify-center'>
            {user.flying.map((card) => <Card key={card.id} info={card} />)}
          </div>
        </div>
      </div>
      <Footer />
