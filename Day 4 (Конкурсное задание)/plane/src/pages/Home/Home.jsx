...
const Home = () => {
  return (
    <div className="container flex justify-between mt-24 items-center md:flex-col md:mt-12">
      ...
      <div className=''>
        <div className="w-9/12 ml-auto md:hidden">
          <img src="https://images.unsplash.com/photo-1494145904049-0dca59b4bbad?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=688&q=80" alt="Logo" />
        </div>
      </div>
    </div>
  )
