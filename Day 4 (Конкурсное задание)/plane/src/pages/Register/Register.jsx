    ...
    return (
        <div>
            <form className="w-2/4 mx-auto mt-20 md:mt-10 sm:w-3/4" action="">
                ...
                <div>
                    <Input Required={true} dopStyles={"mb-2 border-2 rounded"} bgText={"Email"} className="" getVal={newValEmail} />
                    <Input Required={true} dopStyles={"mb-2 border-2 rounded"} bgText={"Пароль"} className="" getVal={newValPassword} />
                    <Input Required={true} dopStyles={"mb-2 border-2 rounded"} bgText={"Никнейм"} className="" getVal={newValNikname} />
                    <Input Required={true} dopStyles={"mb-8 border-2 rounded"} bgText={"Дата рождения"} className="" getVal={newValDate} />
