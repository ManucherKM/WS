...
const Card = (props) => {
    ...
    return (
        <div className={`max-w-sm bg-white rounded-lg border border-gray-300 shadow-m md:max-w-full`}>
            ...
            <div className="p-5">
                <Link href="#">
                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Отдых в горах 2022</h5>
                </Link>
                ...
                <Link href="#" className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-black bg-yellow-400 hover:text-white rounded-lg hover:bg-yellow-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                    Смотреть
